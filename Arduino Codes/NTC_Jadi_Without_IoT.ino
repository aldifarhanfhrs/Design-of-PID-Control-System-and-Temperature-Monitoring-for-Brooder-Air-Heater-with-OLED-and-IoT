...
#define btnDown 32
#define btnBack 34
#define ThermistorPin 36 // 25
#define MQ135Pin 26 // 39
#define outputPin  19 
#define zerocross  18
...
//IoT Ubidots
//======================================================
const char *UBIDOTS_TOKEN = "BBBFF-Ttejc8d6NhRCD0E2yPU9NA5RkxcjsR";  // Put here your Ubidots TOKEN
const char *WIFI_SSID = "fat";      // Put here your Wi-Fi SSID
const char *WIFI_PASS = "gaizka12345";      // Put here your Wi-Fi password
const char *DEVICE_LABEL = "esp32";   // Put here your Device label to which data  will be published
const char *VARIABLE_LABEL1 = "Suhu";
const char *VARIABLE_LABEL2 = "Udara";
const char *VARIABLE_LABEL3 = "Set Value";
const char *VARIABLE_LABEL4 = "Kp";
const char *VARIABLE_LABEL5 = "Ki";
const char *VARIABLE_LABEL6 = "Kd";
...
void loop() {
  ...
  if ((millis() - timer) > PUBLISH_FREQUENCY) // triggers the routine every 5 seconds
  {
    ...
    ubidots.add(VARIABLE_LABEL6, value6);
